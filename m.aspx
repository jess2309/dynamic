<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="m.aspx.cs" Inherits="air_conditioning.m" %>
...
<body>
    <form id="form1" runat="server">
      ...
      <p class="auto-style52">
        ...
        <asp:Label ID="Label1" runat="server" Text="HOME/SERVICES" CssClass="auto-style75" Font-Size="30pt" ForeColor="Gray"></asp:Label>
            <asp:Label ID="Label2" runat="server" Text="MAINTENANCE" CssClass="auto-style92" Font-Size="30pt"></asp:Label>
   ...
   <p>
            ...
            <asp:Image ID="Image2" runat="server" CssClass="auto-style3" ImageUrl="~/IMAGES/maintenance.jpg" />
            <p>
    ...
    <p class="auto-style11">
        <strong><span class="auto-style13">Maintenance & Repair</span></strong>
        <br />
        <br />
