<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="appntmnt.aspx.cs" Inherits="air_conditioning.appntmnt" %>
    ...
    <form id="form1" runat="server">
      ...
      <p class="auto-style52">
        ...
        <asp:Label ID="Label1" runat="server" Text="HOME/" CssClass="auto-style75" Font-Size="30pt" ForeColor="Gray"></asp:Label>
            <asp:Label ID="Label2" runat="server" Text="APPOINTMENT" CssClass="auto-style92" Font-Size="30pt"></asp:Label>
