<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="cl.aspx.cs" Inherits="air_conditioning.cl" %>
...
<body>
    <form id="form1" runat="server">
      ...
      <p class="auto-style52">
        ...
        <asp:Label ID="Label1" runat="server" Text="HOME/SERVICES" CssClass="auto-style75" Font-Size="30pt" ForeColor="Gray"></asp:Label>
            <asp:Label ID="Label2" runat="server" Text="COMMERCIALS" CssClass="auto-style92" Font-Size="30pt"></asp:Label>
   ...
   <p>
            ...
            <asp:Image ID="Image2" runat="server" CssClass="auto-style3" ImageUrl="~/IMAGES/support staff.png" />
            <p>
    ...
    <p class="auto-style11">
        <strong><span class="auto-style13">Commercials</span></strong>
        <br />
        <br />
